...
> to your project root so Claude can use it as context when working with Rook.
> You can customize the copy with project-specific conventions (units, layer
> naming, etc.) — the Rook guidance below will still apply.
