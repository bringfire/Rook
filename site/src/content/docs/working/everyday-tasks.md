...
description: The organizing, cleanup, and setup work Rook is happiest doing.
sidebar:
  order: 2
---

The fastest way to feel Rook's value isn't asking it to design something — it's
handing off the work that *surrounds* designing. The naming, sorting, tidying, and
setting-up that eats your time but isn't the creative part.
...
Rook reads what's there and brings order to it — so you're not dragging objects
between layers by hand.
...
The thread running through all of this: **Rook clears the path so you can design.**
When you *do* want help with the design itself, see
[How to Ask for Things](/Rook/working/asking-rook/).
