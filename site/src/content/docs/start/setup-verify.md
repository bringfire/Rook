...
see [Claude Code & Desktop](/Rook/plugin/claude/) for manual setup.
...
[Plugin Overview](/Rook/plugin/overview/) for how to add it.

## Troubleshooting

| Symptom | Likely cause | Fix |
|---------|--------------|-----|
| `rook` not in the MCP list | MCP config missing or wrong path | Re-run the installer, or add it manually ([Claude Code](/Rook/plugin/claude/)) |
...
| Tools work but no skills | Plugin not installed in Claude Code | [Install the plugin](/Rook/plugin/overview/) |

## Next

Once everything passes, head to
[Your First Conversation](/Rook/start/first-conversation/) — or skim the
[Skills That Ship](/Rook/plugin/skills/) to see what you can ask for.
