...
[Install Rook](/Rook/start/install/).
...
[Claude Code release table](/Rook/plugin/claude/#manual-mcp-configuration).
...
[Set Up & Verify](/Rook/start/setup-verify/) page — the MCP and Rhino checks work
