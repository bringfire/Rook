...
Run the Rook installer ([Install Rook](/Rook/start/install/)). It registers the MCP
server for Claude Code automatically and copies the skills, agents, and hooks into
place. Restart Rhino, then [verify](/Rook/start/setup-verify/).
...
```text
/plugin marketplace add bringfire/Rook
...
Hand your agent the [Set Up & Verify](/Rook/start/setup-verify/) page.
