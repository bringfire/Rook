...
- Image — **live**
- Video — **queued** ([Director](/Rook/modules/director/) is shipping)
- 3D — **arriving** (see [Hunyuan 3D](/Rook/modules/hunyuan-3d/))
...
- [Image Round-Trip](/Rook/modules/image-round-trip/) — the round-trip in detail
- [Many Providers](/Rook/modules/multi-provider/) — the models behind it
