...
1. **Reference image** — a [RookVision](/Rook/modules/rookvision/) capture, an
...
build on it with the [3D Pipeline](/Rook/modules/3d-pipeline/).
...
- [3D Pipeline](/Rook/modules/3d-pipeline/) · [RookSplat](/Rook/modules/rooksplat/)
