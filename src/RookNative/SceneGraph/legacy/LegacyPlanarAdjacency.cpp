// LegacyPlanarAdjacency.cpp
//
// FROZEN LEGACY COPY of the Gate 4 Clipper2-based exact planar-adjacency engine
// implementation. Verbatim copy of the original PlanarAdjacencyEngine.cpp body,
// re-homed under `namespace Rook::Legacy`. NO logic changes.
//
