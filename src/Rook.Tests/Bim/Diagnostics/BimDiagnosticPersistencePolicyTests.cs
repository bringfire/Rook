    ...
    public sealed class BimDiagnosticPersistencePolicyTests
    {
        ...
        public void EveryStage_HasAnExplicitSparsePolicyAndEveryFailureIsPersisted()
        {
            ...
            var policy = new Dictionary<BimDiagnosticStage, bool>
            {
                ...
                [BimDiagnosticStage.RevitDocumentIdentityClassify] = false,
                [BimDiagnosticStage.RevitDocumentCreationGuid] = false,
                [BimDiagnosticStage.RevitDocumentModelPathConvert] = false,
                [BimDiagnosticStage.RevitDocumentPathCanonicalize] = false,
                [BimDiagnosticStage.RevitDocumentKeySource] = false,
                [BimDiagnosticStage.RevitDocumentIdentityCompare] = false,
