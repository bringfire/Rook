...
namespace Rook.Tests.Bim.Diagnostics
{
    public sealed class BimDiagnosticJsonEncoderTests
    {
        ...
        public static IEnumerable<object[]> DetailCodeCases => Cases(
            ...
            (BimDiagnosticDetailCode.FileWorkshared, "file_workshared"),
            (BimDiagnosticDetailCode.SavedProject, "saved_project"),
            (BimDiagnosticDetailCode.Family, "family"),
            (BimDiagnosticDetailCode.Match, "match"),
            (BimDiagnosticDetailCode.Mismatch, "mismatch"),
            (BimDiagnosticDetailCode.Unavailable, "unavailable"),
            (BimDiagnosticDetailCode.InvalidEvidence, "invalid_evidence"),
        ...
        public static IEnumerable<object[]> StageCases => Cases(
            ...
            (BimDiagnosticStage.RevitDocumentIdentityClassify, "revit.document.identity_classify"),
            (BimDiagnosticStage.RevitDocumentCreationGuid, "revit.document.creation_guid"),
            (BimDiagnosticStage.RevitDocumentModelPathConvert, "revit.document.model_path_convert"),
            (BimDiagnosticStage.RevitDocumentPathCanonicalize, "revit.document.path_canonicalize"),
            (BimDiagnosticStage.RevitDocumentKeySource, "revit.document.key_source"),
            (BimDiagnosticStage.RevitDocumentIdentityCompare, "revit.document.identity_compare"),
