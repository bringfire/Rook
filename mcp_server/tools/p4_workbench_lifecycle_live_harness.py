...
async def main() -> int:
    ...
    try:
        ...
        # 2. list shows it
        lst = parse_call_tool_data(await server.call_tool("rhino_workbench_list", {}))
        ...
        mut = text_from_call_tool_result(await server.call_tool(
            "rhino_execute",
        ...
        lst2 = parse_call_tool_data(await server.call_tool("rhino_workbench_list", {}))
