...
_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "rhino_layer_create": "Create a new layer using a single-segment name and optional parent layer",
    "rhino_layer_create_batch": "Create multiple layers atomically from explicit key/parentKey relationships",
