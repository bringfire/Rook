...
def get_all_tools() -> list[str]:
    ...
    try:
        ...
        return [
            ...
            "rhino_layer_set_properties", "rhino_layer_rename",
            "rhino_layer_move_objects", "rhino_layer_merge", "rhino_layer_dependencies",
            "rhino_material_purge", "rhino_linetypes", "rhino_linetype_purge",
            ...
            "rhino_block_replace_object_geometry", "rhino_block_transform_object",
