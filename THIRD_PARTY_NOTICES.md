...
The (legacy, now-shelved) planar adjacency engine vendored **Clipper2** by Angus Johnson
(https://github.com/AngusJohnson/Clipper2), licensed under the **Boost Software License 1.0**.
